...
function modal() {
  ...
  btnclose.addEventListener("click",()=>{
    ...
    if (btnclose) {
      ...
      // <p>Hola estas seguro/a <br>que desea cerrar</p>
      // <div class="btnbotones_aletar" id="btnbotones_aletar">
      //   <button id="aceptar">Aceptar</button>
      //   <button id="canselar">Canselar</button>
      //   </di>
      // </div>

      container_alerta.append()
...
shopping.addEventListener("click",()=>{
  ...
  const eleminar =  titulo_producto.querySelector(".delete")
...
const indecat= agregar_producto_carro.finIndex((intem)=>intem.id ==id)
console.log(indecat)
})
